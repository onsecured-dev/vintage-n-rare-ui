...
export const electricGuitars = process.env.NODE_ENV == "production" ? main_electricGuitars : test_electricGuitars
export const acousticGuitars = process.env.NODE_ENV == "production" ? main_acousticGuitars : test_acousticGuitars
export const electricBass = process.env.NODE_ENV == "production" ? main_electricBass : test_electricBass
export const ampsEffects = process.env.NODE_ENV == "production" ? main_ampsEffects : test_ampsEffects
